...
namespace Backlog\BacklogBundle\Twig;
...
class BacklogExtension extends \Twig_Extension
{
    ...
    {
        $tpl = $this->container->get('bl_backlog.row_manager')->getProvider($row)->getRowTemplate();
    ...
    {
        $tpl = $this->container->get('bl_backlog.row_manager')->getProvider($row)->getShowTemplate();
    ...
    {
        $tpl = $this->container->get('bl_backlog.row_manager')->getProvider($row)->getEditTemplate();
    ...
    {
        $tpl = $this->container->get('bl_backlog.row_manager')->getProvider($row)->getNewTemplate();
    ...
    {
        return $this->container->get('bl_backlog.row_manager')->getProviders();
    }
